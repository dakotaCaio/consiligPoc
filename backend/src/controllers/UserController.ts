...
import FinAllUserService from "../services/UserServices/FindAllUserService";
...
export const updateStatus = async (userId: number, online: boolean) => {
  try {
...
export const list = async (req: Request, res: Response): Promise<Response> => {
  ...
  const queryCompanyId = (profile === 'admin' || profile === 'superbp') 
    ? undefined 
...
export const all = async (req: Request, res: Response): Promise<Response> => {
  ...
  const users = await FindAllUserService(name, companyId);
