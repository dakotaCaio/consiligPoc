                ...
                <Form>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12}>
                            <Field
                                as={TextField}
                                label={i18n.t("contactModal.form.cnpj/cpf")}
                                name="cnpj_cpf"
                                error={touched.cnpj_cpf && Boolean(errors.cnpj_cpf)}
                                helperText={touched.cnpj_cpf && errors.cnpj_cpf}
                        ...
                        <Grid item xs={12}>
                            <Field
                                as={TextField}
                                label="Contract" // Altere para a tradução apropriada
                                name="contract"
