...
const CampaignModal = ({
  ...
  initialValues={{
    ...
    mainTemplate: campaign.mainTemplate || "Olá"
  }}
                    ...
                    <Grid xs={12} md={4} item>
                      ...
                      >
                        ...
                        <Field
                          ...
                          placeholder={i18n.t("campaigns.dialog.form.template")}
                          ...
                          onChange={(e) => {
                            ...
                            if (selectedTemplate) {
                              setFieldValue("mainTemplate", selectedTemplate); 
                            }
                          }}
                          disabled={!campaignEditable}
                        >
                          ...
                          {templates.length === 0 ? (
                            <MenuItem value="" disabled>
                              {i18n.t("campaigns.dialog.form.noTemplates")}
                            </MenuItem>
                          ) : (
