...
const TemplatesModal = ({ open, onClose, onSave, initialData }) => {
  ...
  return (
    <Modal open={open} onClose={onClose} className="templateModal">
      <Box
        sx={{
          position: "absolute",
          display: "flex",
      ...
      >
        ...
        <main style={{ display: "flex", flexFlow: "column", justifyContent: "flex-start" }}>
          <span className={classes.span}>Template Principal</span>
          <TextField
            ...
            sx={{ mb: 2 }}
          />
          <span className={classes.span}>Template de Repescagem 1</span>
          <TextField
            ...
            sx={{ mb: 2 }}
          />
          <span className={classes.span}>Template de Repescagem 2</span>
          <TextField
