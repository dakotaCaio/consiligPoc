...
const TicketListItemCustom = ({ ticket }) => {
  ...
  }, [classes.lastInteractionLabel, ticket]); // Executando apenas uma vez ao montar o componente
        ...
        <ListItemText
          ...
          primary={
            <span className={classes.contactNameWrapper}>
              <Typography noWrap component="span" variant="body2" color="red">
                <strong style={{ display: "flex", flexFlow: "row" }}>
                  <span
                  ...
                  <span className="lastInteraction">
