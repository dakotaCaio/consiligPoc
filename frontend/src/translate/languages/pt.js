  ...
  pt: {
    translations: {
      ...
      connections: {
        title: "Dispositivos",
        toasts: {
          deleted: "Dispositivo com o WhatsApp excluída com sucesso!",
        },
        confirmationModal: {
          deleteTitle: "Deletar",
        ...
        toolTips: {
          ...
          connected: {
            title: "Dispositivo estabelecida!",
          },
          timeout: {
            title: "A Dispositivo com o celular foi perdida",
            content:
      ...
      whatsappModal: {
        ...
        form: {
          name: "Nome",
          default: "Padrão",
          sendIdQueue: "Segmentos",
          timeSendQueue: "Redirecionar para Segmentos em X minutos",
          queueRedirection: "Redirecionamento de Segmentos",
		  outOfHoursMessage: "Mensagem de fora de expediente",
          queueRedirectionDesc: "Selecione uma Segmentos para os contatos que não possuem Segmentos serem redirecionados",
          prompt: "Prompt",
      ...
      contactModal: {
        ...
        form: {
          ...
          email: "Email",
          extraName: "Nº do Contrato",
          extraValue: "Valor",
          whatsapp: "Dispositivo Origem: "
        },
        buttons: {
      ...
      queueModal: {
        title: {
          add: "Adicionar Segmentos",
          edit: "Editar Segmentos",
        },
		confirmationModal: {
		  "deleteTitle": "Excluir",
		},
        form: {
          ...
          token: "Token",
          orderQueue: "Ordem da Segmentos (Bot)",
      ...
      userModal: {
        ...
        form: {
          ...
          password: "Senha",
          profile: "Perfil",
          whatsapp: "Dispositivo Padrão",

          allTicket: "Ticket Sem Segmentos [Invisível]",
      ...
      transferTicketModal: {
        ...
        fieldLabel: "Digite para buscar um Operador",
        fieldQueueLabel: "Transferir para Segmentos",
        fieldQueuePlaceholder: "Selecione uma Segmentos",
      ...
      ticketsList: {
        pendingHeader: "STAND BY",
        assignedHeader: "Atendendo",
        noTicketsTitle: "Nada aqui!",
        noTicketsMessage:
          "Nenhum atendimento encontrado com essa tabulação ou termo pesquisado",
        buttons: {
          accept: "Aceitar",
          closed: "Finalizar",
          reopen: "Reabrir"
      ...
      mainDrawer: {
        listItems: {
          ...
          connections: "Dispositivos",
          tickets: "Chat de Atendimento",
          quickMessages: "Respostas Rápidas",
          contacts: "Base de Clientes",
          queues: "Gerenciamento de Segmentos",
          history: "Histórico de Conversas",
          shooting: "Relatório de Disparo",
          relatoriesFull: "Todos os relatórios",
          deletet: "Você tem certeza que deseja deletar o template:",
          templates: "Templates",
          csv:"Relatório Completo CSV",
          tags: "Tabuação",
          templates: "Relatório de Templates",
          administration: "Administração",
          users: "Gestão de Operadores",
          settings: "Configurações",
          helps: "Ajuda",
          messagesAPI: "API",
          relatories: "Relatórios",
          schedules: "Agendamentos",
          campaigns: "Disparo Massivo",
      ...
      queueIntegration: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! e será removida das Segmentos e Dispositivos vinculadas",
        },
      },
      files: {
      ...
      campaigns: {
        ...
        dialog: {
          new: "Novo Disparo Massivo",
          update: "Editar Disparo",
        ...
        toasts: {
          ...
          cancel: "Disparo Massivo cancelado",
          restart: "Disparo Massivo reiniciado",
          deleted: "Registro excluído",
        },
      },
      announcements: {
      ...
      campaignsConfig: {
        title: "Configurações de Disparo Massivo",
      },
      queues: {
        title: "Segmentos",
        table: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! Os atendimentos dessa Segmentos continuarão existindo, mas não terão mais nenhuma Segmentos atribuída.",
        },
      },
      queueSelect: {
        inputLabel: "Segmentos",
      },
      users: {
        title: "Usuários",
        table: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Todos os dados do usuário serão perdidos. Os atendimento abertos deste usuário serão movidos para a Segmentos.",
        },
      },
      helps: {
      ...
      tags: {
        ...
        confirmationModal: {
          ...
          deleteMessage: "Esta ação não pode ser revertida.",
		  deleteAllMessage: "Tem certeza que deseja deletar todas as Tabulações?",
		  deleteAllTitle: "Deletar Todos",
        },
        table: {
          name: "Nome",
          color: "Cor",
          tickets: "Registros de Tabulações",
          actions: "Ações",
        },
        buttons: {
          add: "Nova Tabulação",
        ...
        toasts: {
		  deletedAll: "Todos as Tabulações excluídos com sucesso!",
      ...
      backendErrors: {
        ...
        ERR_NO_DEF_WAPP_FOUND:
          "Nenhum WhatsApp padrão encontrado. Verifique a página de Dispositivos.",
        ERR_WAPP_NOT_INITIALIZED:
          "Esta sessão do WhatsApp não foi inicializada. Verifique a página de Dispositivos.",
        ERR_WAPP_CHECK_CONTACT:
          "Não foi possível verificar o contato do WhatsApp. Verifique a página de Dispositivos",
        ERR_WAPP_INVALID_CONTACT: "Este não é um número de Whatsapp válido.",
        ERR_WAPP_DOWNLOAD_MEDIA:
          "Não foi possível baixar mídia do WhatsApp. Verifique a página de Dispositivos.",
        ERR_INVALID_CREDENTIALS:
          "Erro de autenticação. Por favor, tente novamente.",
        ERR_SENDING_WAPP_MSG:
          "Erro ao enviar mensagem do WhatsApp. Verifique a página de Dispositivos.",
        ...
        ERR_WAPP_GREETING_REQUIRED:
          "A mensagem de saudação é obrigatório quando há mais de uma Segmentos.",
      },
    },
  },
};
