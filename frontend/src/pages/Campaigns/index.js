...
const Campaigns = () => {
  ...
  return (
    <MainContainer>
      ...
      />
      <MainHeader>
        <Grid style={{ width: "99.6%", alignItems: "center" }} container>
          <Grid xs={12} sm={8} item>
            <Title>{i18n.t("campaigns.title")}</Title>
          </Grid>
          <Grid xs={12} sm={4} item>
            <Grid spacing={2} container style={{flexWrap: "nowrap"}}> 
              <Grid xs={6} sm={6} item>
                <TextField
                  fullWidth
              ...
              <Grid xs={6} sm={6} item style={{whiteSpace: "nowrap", maxWidth: "none"}}>
                <Button
                  fullWidth
                  variant="contained"
